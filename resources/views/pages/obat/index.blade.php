...
@section('content')
    <x-main-content>
        <x-section-header :title="'Data Obat'" :btnBack="false"></x-section-header>

        <div class="section-body">
            <h2 class="section-title">Index</h2>
            <div class="card">
                <div class="card-header justify-content-between">
                    <a href="{{ route('obat.create') }}" class="btn btn-primary btn-icon icon-left">
...
@section('js')
    ...
    <script>
        $('.btn-delete').on('click', function() {
            ...
            $('#form-delete').attr('action', '/obat/' + $(this).data('id'));
