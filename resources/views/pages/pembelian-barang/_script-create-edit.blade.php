<script>
    let index = {{ count(old('items', $pembelian->itemPembelianBarangs ?? [null])) }};
...
<tr class="border-bottom">
    ...
    <td>
        <input type="number" name="items[${index}][harga_satuan]" class="form-control" required>
    </td>
    <td>
        <select name="items[${index}][supplier_id]" class="form-control select-supplier select2" required>
