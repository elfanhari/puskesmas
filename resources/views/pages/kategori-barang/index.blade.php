...
@section('content')
    <x-main-content>
        <x-section-header :title="'Data Kategori Barang'" :btnBack="false"></x-section-header>

        <div class="section-body">
            <h2 class="section-title">Index</h2>
            <div class="card">
                <div class="card-header justify-content-between">
                    <a href="{{ route('kategori-barang.create') }}" class="btn btn-primary btn-icon icon-left">
                            ...
                            <tbody>
                                @foreach ($kategoriBarang as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ route('kategori-barang.edit', $item->id) }}" class="btn btn-sm btn-warning">
...
@section('js')
    ...
    <script>
        $('.btn-delete').on('click', function() {
            ...
            $('#form-delete').attr('action', '/kategori-barang/' + $(this).data('id'));
